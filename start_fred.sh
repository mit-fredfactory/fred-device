...
python3 fred-device/main.py --endpoint a2jz91nv8kralk-ats.iot.us-east-1.amazonaws.com --ca_file root-CA.crt --cert thing_Fred1.cert.pem --key thing_Fred1.private.key